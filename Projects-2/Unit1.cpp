...
//		SysAllocString(L"SELECT * FROM Win32_DiskDrive WHERE InterfaceType='USB'"),
    ...
    {
		VARIANT vtModel, vtSize, vtSerial, vtIndex, vtType, vtDeviceID;
		...
		pObj->Get(L"DeviceID",  0, &vtDeviceID, 0, 0);
        ...
        UnicodeString PhysicalPath = vtDeviceID.vt == VT_BSTR ? vtDeviceID.bstrVal : L"";
